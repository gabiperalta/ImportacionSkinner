Attribute VB_Name = "Accenture"
Option Explicit

Public Sub ImportarAccenture()
...
'===='Comienzo de lectura del excel======================================
    ...
    If vgidCampana = 1004 Or vgidCampana = 782 Or vgidCampana = 988 Or vgidCampana = 1005 Or vgidCampana = 978 Then
        v = DateAdd("yyyy", 1, vgFECHAVIGENCIA)
        vgFECHAVENCIMIENTO = v
    End If
     
    '1004 es ASISTENCIA GLOBAL | 782 es AMMMA | 988 es EMPLEADOS COLON | 1005 es LA RED DE SERVICIOS
    '978 es ARCOR | 62 es ASMEPRIV
    
    If vgidCampana = 62 Then
        v = Mid(vgNROPOLIZA, 4)
        vgNROPOLIZA = v
    End If
...
'    If vCantDeErrores = 0 Then
    ...
    '       para indicar que haria que cambiarle en produccion la corrida y la feca de corrida
         ...
         End If
            ...
            If vgFECHAVIGENCIA = "00:00:00" Then
                vgFECHAVIGENCIA = (rscn1("FECHAVIGENCIA"))
            End If
            ...
            If vgFECHAVENCIMIENTO = "00:00:00" Then
                vgFECHAVENCIMIENTO = DateAdd("m", 3, vgFECHAVIGENCIA)
             '   vgFECHAVENCIMIENTO = DateAdd("m", 3, (rscn1("FECHAVIGENCIA")))
            End If
                rscn1.Close
