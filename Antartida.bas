Attribute VB_Name = "Antartida"
Option Explicit
Public Sub ImportarAntartida()
...
vCantDeErrores = 0
    ...
    cn.Execute "DELETE FROM bandejadeentrada.dbo.importaDatos27"
...
'        vgIDAUTO = Mid(sLine, 1, 10)
 ...
 '       End If
        ...
        ElseIf Trim(Mid(sLine, 275, 2)) = "P" Then
            vgTIPODEVEHICULO = 3
        ElseIf Trim(Mid(sLine, 275, 2)) = "C" Then
            vgTIPODEVEHICULO = 4
...
'-=================================================================================================================
        ...
        ssql = "Insert into bandejadeentrada.dbo.importaDatos27 ("
        ssql = ssql & "IDPOLIZA, "
        ssql = ssql & "IDCIA, "
