Attribute VB_Name = "Boston"
Option Explicit
Public Sub ImportarBoston()
...
cn.Execute "DELETE FROM bandejadeentrada.dbo.ImportaDatosBoston"
...
'        vgIDAUTO = Mid(sLine, 1, 10)
 ...
 '      -------------------------------------------------------
        vCampo = "AÑO"
        vPosicion = 259
        If IsNumeric(Mid(sLine, 259, 4)) Then
...
'-=================================================================================================================
        ...
        ssql = "Insert into bandejadeentrada.dbo.ImportaDatosBoston ("
        ssql = ssql & "IDPOLIZA, "
        ssql = ssql & "IDCIA, "
