Attribute VB_Name = "FortalezaSeguros"
Public Sub ImportarFortalezaSeguros()
...
camposParaValidar(5) = "CODIGO DE ASEGURADO"
...
'===='Comienzo de lectura del excel======================================
        ...
        Select Case UCase(Trim(sName))
                ...
                Case "APELLIDOYNOMBRE"
                    ...
                    vCantDeErrores = vCantDeErrores + LoguearError(Err, flnErr, vgidCampana, "", lRow, sName)
                Case "GENERO"
                    If UCase(Mid(v, 1, 8)) = "FEMENINO" Then
                        vgSexo = "F"
                    ElseIf UCase(Mid(v, 1, 9)) = "MASCULINO" Then
                        vgSexo = "M"
                    End If
                    vCantDeErrores = vCantDeErrores + LoguearError(Err, flnErr, vgidCampana, "", lRow, sName)
                Case "IDPRODUCTO"
