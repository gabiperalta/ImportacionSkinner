Attribute VB_Name = "Liderar_Vargas"
Option Explicit
Public Sub ImportarLiderarVargas()
...
cn.Execute "DELETE FROM bandejadeentrada.dbo.ImportaDatos24"
...
'-=================================================================================================================
        ...
        ssql = "Insert into bandejadeentrada.dbo.ImportaDatos24 ("
        ssql = ssql & "IDPOLIZA, "
        ssql = ssql & "IDCIA, "
