Attribute VB_Name = "PSA_Peugeot"
Option Explicit
Public Sub ImportarPSAPeugeot()
...
'        vgIDAUTO = Mid(sLine, 1, 10)
 '      -------------------------------------------------------
        ...
        If Trim(vgMARCADEVEHICULO) <> "PEUGEOT" Then
            MsgBox "Este vehiculo no es PEUGEOT, revise la base"
            Exit Sub
        End If
 '      -------------------------------------------------------
        vCampo = "MODELO"
