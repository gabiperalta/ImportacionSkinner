Attribute VB_Name = "QualiaAnterior"
Option Explicit

Public Sub ImportarExelQualiaAnterior()
...
'Dim vgNROSECUENCIAL As Long
'Dim vgCodigoEnCliente As Long
'Dim vgOcupacion As String
'Dim vgAgencia As Long
'Dim vgCargo As String
'Dim vgCanal As Integer
'Dim vgNombre As String
'Dim vgApellido As String
'Dim vgIdEnCliente As String
'Dim vgTipodeServicio As Integer
'Dim vgTipodeDocumento As String
'Dim vgNumeroDeDocumento As String
'Dim vgSexo As Integer
'Dim vgCuit As Integer
'Dim vgNroDeTarjetaDeCredito As String
'Dim vgCBU As String
'Dim vgFECHAVIGENCIA As Date
'Dim vgFechaModificacion As Date
'Dim vgFECHAVENCIMIENTO As Date
'Dim vgMotivoBaja As String
'Dim vgCondicionIVA As Integer
'Dim vgOperacion As Integer
'Dim vgDescripcionDelProducto As String
'Dim vgIdProducto As Long
'Dim vgMontoAsegurado As Double
'Dim vgFormaDePago As String
'Dim vgModulo As Long
'Dim vgDescripcionDelModulo As String
'Dim vgValorDeAccesorios As Double
'Dim vgPaisOrigen As String
'Dim vgNacionalidad As Integer
'Dim vgPais As Long
'Dim vgCODIGOPOSTAL As Long
'Dim vgDOMICILIO As String
'Dim vgLOCALIDAD As String
'Dim vgPROVINCIA As Integer
'Dim vgEmail As String
'Dim vgTipoTelefono1 As Integer
'Dim vgTelefono As String
'Dim vgTipoTelefono2 As Integer
'Dim vgTelefono2 As String
'Dim vgCuentaDeDebito As String
'Dim vgSucursalCuenta As Integer
'Dim vgDigitoVerificador As Integer
'Dim vgNroUltimoRecibo As Integer
'Dim vgPrima As Integer
'Dim vgPremio As Integer
'Dim vgDeuda As Integer
'Dim vgCalleDelBienAsegurado As String
'Dim vgNumeroDelBienAsegurado As Integer
'Dim vgDptoDelBienAsegurado As String
'Dim vgPisoDelBienAsegurado As Integer
'Dim vgProvinciaDelBienAsegurado As Integer
'Dim vgCPDelBienAsegurado As Integer
'Dim vgLocalidadDelBienAsegurado As String
'Dim vgTecho As Integer
'Dim vgVentanas As Integer
'Dim vgAntiguedad As Integer
'Dim vgTipoCerradura As Integer
'Dim vgDependencias As String
'Dim vgAdicionalSeguroTecnico As Integer
'Dim vgAdicionalPalosDeGolf As Integer
'Dim vgAdicionalNotebook As Integer
'Dim vgAdicionalLCD As Integer
'Dim vgAdicionalconsola As Integer
'Dim vgAdicionalconsolaOp1 As Integer
'Dim vgAdicionalconsolaOp2 As Integer
'Dim vgBeneficiario1Nombre As String
'Dim vgBeneficiario1Apellido As String
'Dim vgBeneficiario1IdTipoDoc As String
'Dim vgBeneficiario1NroDocumento As Integer
'Dim vgBeneficiario1Porcentaje As Integer
'Dim vgBeneficiario1Mail As String
'Dim vgBeneficiario2Nombre As String
'Dim vgBeneficiario2Apellido As String
'Dim vgBeneficiario2IdTipoDoc As String
'Dim vgBeneficiario2NroDoc As Integer
'Dim vgBeneficiario2Porcentaje As Integer
'Dim vgBeneficiario2Mail As String
'Dim vgBeneficiario3Nombre As String
'Dim vgBeneficiario3Apellido As String
'Dim vgBeneficiario3IdTipoDoc As String
'Dim vgBeneficiario3NroDocumento As Integer
'Dim vgBeneficiario3Porcentaje As Integer
'Dim vgBeneficiario3Mail As String
'Variables propias de Qualia
...
'                            rsc("CodigoDeRamo") = v
                            ...
                            If Not rsp.EOF Then
'                                rsc("IdProducto").Value = rsp("idproductomultiasistencias")
                            Else
'                                rsc("IdProducto").Value = -99
                            End If
...
'                            rsc("fechabajaomnia") = AAMMDDToDD_MM_AA(v)
                            vgFECHABAJAOMNIA = AAMMDDToDD_MM_AA(v)
                            vgFECHAVENCIMIENTO = AAMMDDToDD_MM_AA(v)
'                            vgFECHABAJAOMNIA = v
...
'        If DateDiff("d", vgFECHAVENCIMIENTO, Now()) < 0 Then
            ssql = "Insert into bandejadeentrada.dbo.ImportaDatosHorizonte ("
            ssql = ssql & "IDPOLIZA, "
            ssql = ssql & "IDCIA, "
