...
'On Error GoTo errores
    cn.Execute "DELETE FROM bandejadeentrada.dbo.ImportaDatos726"
...
'numdoc
        ...
        If Len(vgNumeroDeDocumento) > 8 Then
        MsgBox "NumDoc debe ser <=8 digitos, numero de linea: " & nroLinea
        Exit Sub
        End If
...
'Domicilio Beneficiario2
        ...
        vPosicion = 22
        vgDOMICILIO = Trim(Mid(sLine, 1, InStr(1, sLine, ";") - 1))
        sLine = Mid(sLine, InStr(1, sLine, ";") + 1)
'Numero
        vCampo = "Numero"
        vPosicion = 23
...
'Suma Aseg.
        vCampo = "Suma Aseg."
        vPosicion = 30
        If IsNumeric(Mid(sLine, 1, InStr(1, sLine, ";") - 1)) Then
...
'Nombre Tomador
        ...
        vPosicion = 31
        vNombreTomador = Mid(sLine, 1, InStr(1, sLine, ";") - 1)
        sLine = Mid(sLine, InStr(1, sLine, ";") + 1)
'Año Novedad
        vCampo = "Año Novedad"
        vPosicion = 32
...
'Cob. Cobranza
        vCampo = "Cob. Cobranza"
        vPosicion = 36
        vCoberturaFinanciera = Mid(sLine, 1, InStr(1, sLine, ";") - 1) 'ESTE ES EL QUE UTILIZA
        sLine = Mid(sLine, InStr(1, sLine, ";") + 1)
'Columna1
        vCampo = "Columna1"
        vPosicion = 37
        vgOBSERVACIONES = Mid(sLine, 1, InStr(1, sLine, ";") - 1)
        sLine = Mid(sLine, InStr(1, sLine, ";") + 1)
'Columna2
        vCampo = "Columna2"
        vPosicion = 38
        ...
        'CARGA VALOR COBERTURA VIAJERO-----------------------------
        Select Case vgTipodeOperacion
            Case 12
            ...
            Case 123
                ...
                vgCOBERTURAAP = "04"
            Case 124
                vgCOBERTURAVIAJERO = "05"
                vgCOBERTURAAP = "05"
            Case 142
                vgCOBERTURAVIAJERO = "06"
                vgCOBERTURAAP = "06"
            Case 143
                vgCOBERTURAVIAJERO = "07"
                vgCOBERTURAAP = "07"
            Case 144
                vgCOBERTURAVIAJERO = "08"
                vgCOBERTURAAP = "08"
            Case 145
                vgCOBERTURAVIAJERO = "09"
                vgCOBERTURAAP = "09"
            Case 146
                vgCOBERTURAVIAJERO = "11"
                vgCOBERTURAAP = "11"
            Case 128
                vgCOBERTURAVIAJERO = "12"
                vgCOBERTURAAP = "12"
            Case 126
                vgCOBERTURAVIAJERO = "13"
                vgCOBERTURAAP = "13"
            Case 134
                vgCOBERTURAVIAJERO = "14"
                vgCOBERTURAAP = "14"
            Case 135
                vgCOBERTURAVIAJERO = "15"
                vgCOBERTURAAP = "15"
            Case 136
                vgCOBERTURAVIAJERO = "16"
                vgCOBERTURAAP = "16"
            Case 137
                vgCOBERTURAVIAJERO = "17"
                vgCOBERTURAAP = "17"
            Case Else
                MsgBox "Poliza sin valor en Campo Rama en linea: " & Ll
        End Select
        
        If vCoberturaFinanciera = "N" Then
            vgCOBERTURAVIAJERO = "98"
            vgCOBERTURAAP = "98"
        End If
        
        'CARGA CODIGO EN CLIENTE PARA ESTA CAMPANA------------------
        vgCodigoEnCliente = "01"
...
'   .
    ...
    ssql = "select *  from Auxiliout.dbo.tm_Polizas  where IdCampana = " & vgidCampana & " and nroPoliza = '" & Trim(vgNROPOLIZA) & "' and NumeroDeDocumento = '" & vgNumeroDeDocumento & "'"
...
'                If Trim(rscn1("Referido")) <> Trim(vgReferido) Then vdif = vdif + 1
        ...
        rscn1.Close
'-=================================================================================================================
        ssql = "Insert into bandejadeentrada.dbo.ImportaDatos726 ("
        ssql = ssql & "IDPOLIZA, "
        ssql = ssql & "IDCIA, "
        ...
        ssql = ssql & "Certificado,CodigoEnCliente,NroSecunecialEnCliente, Modificaciones )"
